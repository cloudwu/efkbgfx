...
vec4 _main(PS_Input Input)
{
    ...
    vec3 _651 = Output.xyz * u_fEmissiveScaling.x;
    ...
    vec3 _745 = mix(u_fEdgeColor.xyz * u_fEdgeParameter.y, Output.xyz, vec3_splat(ceil((Output.w - advancedParam.AlphaThreshold) - u_fEdgeParameter.x)));
